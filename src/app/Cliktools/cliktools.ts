...
export class ClikTools {
    ...
    */
    ...
    /*
        Retorna un tipo File de una imagen dada  
    */
    public async ImgToFile(img: any){
        return new File([await fetch(this.apiclient.url + img.url).then(r => r.blob())], img.name, { type: img.mime });
    }
}